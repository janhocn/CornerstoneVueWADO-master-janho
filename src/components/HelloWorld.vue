...
cornerstoneWADOImageLoader.external.dicomParser = dicomParser; //add by janho
    ...
    show() {
      ...
      if (this.isShow === true) {
        ...
        this.$http
          ...
          //.get(".static/testImages/CTImage.dcm")
          .get("http://localhost:8686/static/Dicom.json")
          .then(function(res) {
            console.log("res:", res);
            ...
            _this.exampleStudyImageIds = res.body.value.testData.testData1;
            console.log(
              "res.body.value.testData.testData1:",
